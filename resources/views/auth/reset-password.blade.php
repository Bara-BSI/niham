<x-guest-layout>
    <div class="mb-8">
        <h2 class="text-3xl font-extrabold text-gray-900 dark:text-gray-100">{{ __('messages.create_new_password') }}</h2>
        <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">
            {{ __('messages.please_enter_and_confirm_your_new_password_below') }}
        </p>
    </div>
