                ...
                <table class="min-w-full divide-y divide-gray-200/50 dark:divide-gray-700/50">
                    <thead class="bg-gray-50/50 dark:bg-gray-800/50">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-center text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider">{{ __('messages.oversight') }}</th>
                    ...
                    <tbody class="divide-y divide-gray-200/50 dark:divide-gray-700/50">
                        @foreach($departments as $department)
                            <tr class="transition-colors duration-200 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                <td class="px-4 py-2 text-sm text-gray-700 dark:text-gray-200">{{ $departments->firstItem() + $loop->index }}</td>
                                ...
                                <td class="px-4 py-2 text-sm text-gray-700 dark:text-gray-200">{{ $department->code }}</td>
                                ...
                                <td class="px-4 py-2 text-sm text-gray-700 dark:text-gray-200">{{ $department->notes??'_' }}</td>
                                @if(Auth::user()->isSuperAdmin())
